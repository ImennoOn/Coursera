---
title: "Human Activity Recognition and Predictive Model Fitting"
...
In this project, the goal will is to use data from accelerometers on the belt, forearm, arm, and dumbell of 6 participants. They were asked to perform barbell lifts correctly and incorrectly in 5 different ways. More information is available from the official website [^website] in the section on the Weight Lifting Exercise Dataset.
...
```{r}
path <- paste(getwd(),"/pml-training.csv", sep = "")
train.raw <- read.csv(path, na.strings=c("","NA"))
dim(train.raw)
